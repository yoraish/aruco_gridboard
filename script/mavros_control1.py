...
def simple_demo():
    ...
    c.takeoff(1.3)
    rospy.sleep(7)
    c.goto_xyz_rpy(0,0,1.3,0,0,0)
    rospy.sleep(3)

    print("Waypoint 1: position control")
    c.goto_xyz_rpy(0.0,0.0,1.3,0,0,-1*pi_2)
    rospy.sleep(3)
    c.goto_xyz_rpy(0.5,0.0,1.3,0,0,-1*pi_2)
    rospy.sleep(4)
    print("Waypoint 2: position control")
    c.goto_xyz_rpy(0.5,0.0,1.3,0,0,0)
    rospy.sleep(3)
    c.goto_xyz_rpy(0.5,0.5,1.3,0,0,0)
    rospy.sleep(4)
    print("Waypoint 3: position control")
    c.goto_xyz_rpy(0.5,0.5,1.3,0,0,pi_2)
    rospy.sleep(3)
    c.goto_xyz_rpy(0.0,0.5,1.3,0,0,pi_2)
    rospy.sleep(4)
    print("Waypoint 4: position control")
    c.goto_xyz_rpy(0.0,0.5,1.3,0,0,2*pi_2)
    rospy.sleep(3)
    c.goto_xyz_rpy(0.0,0.0,1.3,0,0,2*pi_2)
    rospy.sleep(4)
